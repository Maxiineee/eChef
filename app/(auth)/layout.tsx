import imgCozinhando from "@/app/assets/Cozinhando.png";
    ...
    return (
        <div className="flex flex-col sm:items-center sm:justify-center min-h-screen w-full sm:p-4 overflow-y-auto">
            <div className="z-0 relative sm:fixed w-full min-h-36 sm:inset-0 overflow-hidden flex items-center justify-center grow">
                <Image src={imgCozinhando} fill priority alt="Imagem de fundo de uma frigideira com ingredientes" className="object-cover scale-[1.01] brightness-50 sm:blur-sm" />
            ...
            <Card className="z-10 w-full sm:max-w-lg">
                <CardHeader className="flex flex-col gap-2">
                    ...
                    <CardTitle className="text-lg font-bold text-card-foreground" >Cozinhe, compartilhe e descubra sabores</CardTitle>
                </CardHeader>
                <CardContent>
                    {children}
                </CardContent>
